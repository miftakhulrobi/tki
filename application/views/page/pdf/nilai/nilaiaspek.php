...
$pdf->SetHeaderData('LOGOTK.png', 17, "                TAMAN KANAK-KANAK ISLAM MIFTAAHUL JANNAH" . '', "                 JL.BINTORO ll NO.54 PANDEAN LAMPER (081 385 046 431)\n                                          GAYAMSARI-SEMARANG", array(0, 0, 0), array(0, 0, 0));
...
$title = <<<EDD
    <h3>ASPEK PENGEMBANGAN</h3>
EDD;

$subtitle = '<h3>NILAI ' . strtoupper($tabel) . ' SEMESTER ' . $semester . ' BULAN ' . $bulan . ' T.A ' . $year->yearname . '</h3>';
...
$table .=   '<tr>
                ...
                <th style="border: 1px solid grey; width: 540px;">Kemampuan</th>
                <th style="border: 1px solid grey; width: 40px;">Nilai</th>
            </tr>';
$no = 1;
foreach ($aspek as $a) {
    $table .= '<tr>
                    <td style="border: 1px solid grey; width: 40px;">' . $no++ . '</td>
                    <td style="border: 1px solid grey; width: 540px;">' . $a->kemampuan . '</td>
                    <td style="border: 1px solid grey; width: 40px">' . $a->nilai . '</td>
                </tr>';
}
$table .= '</table>';
...
$ttd = '<table>
            ...
            <tr>
                <td>Ttd Wali Murid</td>
                <td></td>
                <td></td>
                <td>Ttd Wali Kelas</td>
            </tr>
            <tr>
                <td></td>
                <td></td>
...
$pdf->writeHTMLCell(0, 0, '', '', $tgl, 0, 1, 0, true, 'R', true);
