                ...
                <div class="card card-table-data">
                    <div class="card-header">
                        <div class="card-title">Siswa Kelas <?= $classes->classname ?> T.A. <?= $year->yearname ?>
                            <a href="<?= base_url('master/createsiswa/' . $classes->class_id . '/' . $year->year_id) ?>" class="btn btn-success btn-sm btn-hover float-right">Tambah Siswa</a>
                        </div>
                    </div>
                                ...
                                foreach ($siswa as $s) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url('master/siswaedit/' . $s->siswa_id) ?>" class="btn btn-info btn-sm btn-hover">Edit</a>
                                            <a href="#" class="btn btn-info btn-sm btn-hover hapus-siswa" siswa_id="<?= $s->siswa_id ?>">Hapus</a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
